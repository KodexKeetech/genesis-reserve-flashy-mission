...
const VICTORY_BACKGROUND = 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/696532152ae03346493429c1/37e99cc22_ChatGPTImageJan12202607_15_16PM.png';
...
export default function GameOverlay({ type, score, level, onRestart, onNextLevel, onStart, onLoadGame, hasCheckpoint, onContinueFromCheckpoint, difficulty, onDifficultyChange, hiddenLevelId }) {
  ...
  if (type === 'levelComplete') {
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `url(${VICTORY_BACKGROUND})`,
          }}
        />
